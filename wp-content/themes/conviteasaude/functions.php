...
function categoria_adsense()
{
    ...
    register_taxonomy('categorias-adsense', array('adsense'), $args);
}
add_action('init', 'categoria_adsense', 0);
  ...
  function add_category_to_single($classes) {
    if (is_single() || is_archive() ) {
      ...
      foreach((get_the_category($post->ID)) as $category) {
        ...
        $classes[] = 'page-template-'.$category->category_nicename;
      }
    }
